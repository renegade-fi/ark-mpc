...
// #[derive(Debug)]
// pub struct AuthenticatedRistretto<N: MpcNetwork + Send, S: SharedValueSource> {
...
// impl<N: MpcNetwork + Send, S: SharedValueSource> Clone for AuthenticatedRistretto<N, S> {
//     fn clone(&self) -> Self {
//         Self {
...
// impl<N: MpcNetwork + Send, S: SharedValueSource> AuthenticatedRistretto<N, S> {
//     #[inline]
...
//  */
// impl<N: MpcNetwork + Send, S: SharedValueSource> Visible for AuthenticatedRistretto<N, S> {
//     fn visibility(&self) -> Visibility {
//         self.visibility
//     }
// }

// impl<N: MpcNetwork + Send, S: SharedValueSource> PartialEq for AuthenticatedRistretto<N, S> {
//     fn eq(&self, other: &Self) -> bool {
//         self.value().eq(other.value())
//     }
// }

// impl<N: MpcNetwork + Send, S: SharedValueSource> Eq for AuthenticatedRistretto<N, S> {}

// impl<N: MpcNetwork + Send, S: SharedValueSource> ConstantTimeEq for AuthenticatedRistretto<N, S> {
//     fn ct_eq(&self, other: &Self) -> subtle::Choice {
//         self.value().ct_eq(other.value())
//     }
// }

// impl<N: MpcNetwork + Send, S: SharedValueSource> Clear for AuthenticatedRistretto<N, S> {
...
//  */
// impl<'a, N: MpcNetwork + Send, S: SharedValueSource> Mul<&'a AuthenticatedScalar<N, S>>
...
// impl<'a, N: MpcNetwork + Send, S: SharedValueSource> Mul<&'a AuthenticatedRistretto<N, S>>
...
//  */
// impl<'a, N: MpcNetwork + Send, S: SharedValueSource> Add<&'a AuthenticatedRistretto<N, S>>
//     for &'a AuthenticatedRistretto<N, S>
// {
//     type Output = AuthenticatedRistretto<N, S>;
...
//  */
// impl<'a, N: MpcNetwork + Send, S: SharedValueSource> Sub<&'a AuthenticatedRistretto<N, S>>
//     for &'a AuthenticatedRistretto<N, S>
// {
//     type Output = AuthenticatedRistretto<N, S>;
...
//  */
// impl<'a, N: MpcNetwork + Send, S: SharedValueSource> Neg for &'a AuthenticatedRistretto<N, S> {
//     type Output = AuthenticatedRistretto<N, S>;
...
// impl<N: MpcNetwork + Send, S: SharedValueSource> Neg for AuthenticatedRistretto<N, S> {
//     type Output = AuthenticatedRistretto<N, S>;
...
// #[derive(Debug)]
// pub struct AuthenticatedCompressedRistretto<N: MpcNetwork + Send, S: SharedValueSource> {
...
// impl<N: MpcNetwork + Send, S: SharedValueSource> Clone for AuthenticatedCompressedRistretto<N, S> {
//     fn clone(&self) -> Self {
//         Self {
//             value: self.value.clone(),
//             visibility: self.visibility,
...
// impl<N: MpcNetwork + Send, S: SharedValueSource> AuthenticatedCompressedRistretto<N, S> {
...
// impl<N: MpcNetwork + Send, S: SharedValueSource> IsIdentity
...
// impl<N: MpcNetwork + Send, S: SharedValueSource> ConstantTimeEq
//     for AuthenticatedCompressedRistretto<N, S>
// {
...
// impl<N: MpcNetwork + Send, S: SharedValueSource> Clear for AuthenticatedCompressedRistretto<N, S> {
//     #[allow(clippy::needless_borrow)]
//     fn clear(&mut self) {
//         (&mut self.value).clear();
//     }
