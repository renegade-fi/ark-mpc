...
// #[derive(Debug)]
// pub struct MpcRistrettoPoint<N: MpcNetwork + Send, S: SharedValueSource> {
...
// impl<N: MpcNetwork + Send, S: SharedValueSource> Clone for MpcRistrettoPoint<N, S> {
//     fn clone(&self) -> Self {
//         Self {
//             value: self.value(),
...
//  */
// impl<N: MpcNetwork + Send, S: SharedValueSource> MpcRistrettoPoint<N, S> {
...
//  */
// impl<N: MpcNetwork + Send, S: SharedValueSource> Visible for MpcRistrettoPoint<N, S> {
//     fn visibility(&self) -> Visibility {
//         self.visibility
//     }
// }

// impl<N: MpcNetwork + Send, S: SharedValueSource> PartialEq for MpcRistrettoPoint<N, S> {
//     fn eq(&self, other: &Self) -> bool {
//         self.value().eq(&other.value())
//     }
// }

// impl<N: MpcNetwork + Send, S: SharedValueSource> ConstantTimeEq for MpcRistrettoPoint<N, S> {
//     fn ct_eq(&self, other: &Self) -> subtle::Choice {
//         self.value().ct_eq(&other.value())
//     }
// }

// impl<N: MpcNetwork + Send, S: SharedValueSource> Eq for MpcRistrettoPoint<N, S> {}

// impl<N: MpcNetwork + Send, S: SharedValueSource> Clear for MpcRistrettoPoint<N, S> {
...
// impl<'a, N: MpcNetwork + Send, S: SharedValueSource> Mul<&'a MpcScalar<N, S>>
...
// impl<'a, N: MpcNetwork + Send, S: SharedValueSource> Mul<&'a MpcRistrettoPoint<N, S>>
//     for &'a MpcScalar<N, S>
// {
//     type Output = MpcRistrettoPoint<N, S>;
...
// macros::impl_wrapper_type!(MpcRistrettoPoint<N, S>, Scalar, MpcScalar::from_public_scalar, Mul, mul, *, authenticated=false);
...
//  */
// impl<'a, N: MpcNetwork + Send, S: SharedValueSource> Add<&'a MpcRistrettoPoint<N, S>>
//     for &'a MpcRistrettoPoint<N, S>
// {
//     type Output = MpcRistrettoPoint<N, S>;
...
// macros::impl_wrapper_type!(MpcRistrettoPoint<N, S>, RistrettoPoint, MpcRistrettoPoint::from_public_ristretto_point, Add, add, +, authenticated=false);
...
//  */
// impl<'a, N: MpcNetwork + Send, S: SharedValueSource> Sub<&'a MpcRistrettoPoint<N, S>>
//     for &'a MpcRistrettoPoint<N, S>
// {
//     type Output = MpcRistrettoPoint<N, S>;
...
// macros::impl_wrapper_type!(MpcRistrettoPoint<N, S>, RistrettoPoint, MpcRistrettoPoint::from_public_ristretto_point, Sub, sub, -, authenticated=false);
...
//  */
// impl<N: MpcNetwork + Send, S: SharedValueSource> Neg for MpcRistrettoPoint<N, S> {
//     type Output = MpcRistrettoPoint<N, S>;
...
// impl<'a, N: MpcNetwork + Send, S: SharedValueSource> Neg for &'a MpcRistrettoPoint<N, S> {
//     type Output = MpcRistrettoPoint<N, S>;
...
//  */
// impl<N: MpcNetwork + Send, S: SharedValueSource> MultiscalarMul for MpcRistrettoPoint<N, S> {
//     type Point = Self;
...
// #[derive(Debug)]
// #[allow(dead_code)]
// pub struct MpcCompressedRistretto<N: MpcNetwork + Send, S: SharedValueSource> {
//     /// The underlying value of the Ristretto point in the network
...
// impl<N: MpcNetwork + Send, S: SharedValueSource> Clone for MpcCompressedRistretto<N, S> {
//     fn clone(&self) -> Self {
//         Self {
//             value: self.value(),
//             visibility: self.visibility,
...
//  */
// impl<N: MpcNetwork + Send, S: SharedValueSource> MpcCompressedRistretto<N, S> {
...
// impl<N: MpcNetwork + Send, S: SharedValueSource> IsIdentity for MpcCompressedRistretto<N, S> {
//     fn is_identity(&self) -> bool {
//         self.value.is_identity()
//     }
// }

// impl<N: MpcNetwork + Send, S: SharedValueSource> ConstantTimeEq for MpcCompressedRistretto<N, S> {
//     fn ct_eq(&self, other: &Self) -> Choice {
//         self.value.ct_eq(&other.value)
//     }
// }

// impl<N: MpcNetwork + Send, S: SharedValueSource> Clear for MpcCompressedRistretto<N, S> {
//     #[allow(clippy::needless_borrow)]
//     fn clear(&mut self) {
//         (&mut self.value).clear();
//     }
