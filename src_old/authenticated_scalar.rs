...
// #[derive(Debug)]
// pub struct AuthenticatedScalar<N: MpcNetwork + Send, S: SharedValueSource> {
...
// impl<N: MpcNetwork + Send, S: SharedValueSource> Clone for AuthenticatedScalar<N, S> {
//     fn clone(&self) -> Self {
//         Self {
...
// impl<N: MpcNetwork + Send, S: SharedValueSource> AuthenticatedScalar<N, S> {
//     #[inline]
...
//  */
// impl<N: MpcNetwork + Send, S: SharedValueSource> Visible for AuthenticatedScalar<N, S> {
//     fn visibility(&self) -> Visibility {
//         self.visibility
//     }
// }

// impl<N: MpcNetwork + Send, S: SharedValueSource> PartialEq for AuthenticatedScalar<N, S> {
//     fn eq(&self, other: &Self) -> bool {
//         self.value.eq(other.value())
//     }
// }

// impl<N: MpcNetwork + Send, S: SharedValueSource> Eq for AuthenticatedScalar<N, S> {}

// impl<N: MpcNetwork + Send, S: SharedValueSource> ConstantTimeEq for AuthenticatedScalar<N, S> {
//     fn ct_eq(&self, other: &Self) -> subtle::Choice {
//         self.value.ct_eq(other.value())
//     }
// }

// impl<N: MpcNetwork + Send, S: SharedValueSource> Index<usize> for AuthenticatedScalar<N, S> {
//     type Output = u8;
...
// impl<N: MpcNetwork + Send, S: SharedValueSource> Clear for &mut AuthenticatedScalar<N, S> {
...
//  */
// impl<'a, N: MpcNetwork + Send, S: SharedValueSource> Add<&'a AuthenticatedScalar<N, S>>
//     for &'a AuthenticatedScalar<N, S>
// {
//     type Output = AuthenticatedScalar<N, S>;
...
//  */
// impl<'a, N: MpcNetwork + Send, S: SharedValueSource> Sub<&'a AuthenticatedScalar<N, S>>
//     for &'a AuthenticatedScalar<N, S>
// {
//     type Output = AuthenticatedScalar<N, S>;
...
//  */
// impl<'a, N: MpcNetwork + Send, S: SharedValueSource> Neg for &'a AuthenticatedScalar<N, S> {
//     type Output = AuthenticatedScalar<N, S>;
...
// impl<N: MpcNetwork + Send, S: SharedValueSource> Neg for AuthenticatedScalar<N, S> {
//     type Output = AuthenticatedScalar<N, S>;
